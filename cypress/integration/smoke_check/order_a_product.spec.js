...
describe("B2C - Purchasing products", () => {
	...
	it('Pessenger details can be submitted', () => {
		...
		Order.fill_account_details("dochq", test_data[1].email)
	...
	it('Shipping address and phone number details can be submitted', () => {
		...
		Order.fill_shipping_address("dochq", test_data[1].country_code, test_data[1].phone) // only random UK number is supported
