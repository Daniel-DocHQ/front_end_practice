...
const TermsConditionsEn = () => {
	...
	return (
		<Box className={classes.container}>
			...
			<h3>The test certificate</h3>
			<p>
				The test certificate contains information about yourself, including your surname, first name, date of birth, gender, ID (passport, card or driver’s licence number), details of the test procedure, test date and time, sensitivity and specificity for antigen tests, responsible medical service, responsible doctor, information about the laboratory in case of a PCR test. The certificate is issued in English. This meets the criteria for most occasions where a negative COVID-19 test is required for travelling , but DocHQ and its partners cannot guarantee that this certificate will be recognised for the desired purpose.
			</p>
			<h3>Limits of the test</h3>
			<p>
				The test result can only provide information about the infection status of the person tested at the time the sample was taken. False-positive or false-negative test results are possible. This means: despite a negative test result, you can be infected with SARS-CoV-2, and conversely, a positive test result does not mean that you actually have an acute infection with SARS-CoV-2. A positive result in the rapid antigen test must be confirmed by a diagnostic PCR test. To do this, please contact your family doctor, a public health service test centre or another medical facility and get advice and testing. Until you receive the result of this confirmatory test, you must consider yourself infectious and follow the local regulations on self-isolation.
			</p>
			<h3>Processing of test results (health data)</h3>
			<p>Your health data collected during our services is protected by article 9 of the general data protection regulation (EU) No. 2016/679 (GDPR). The collection and processing of this health data requires your consent. By agreeing to these terms and conditions and participating in the test procedure, you give consent to DocHQ and its partners involved to collect and process this data. In addition, you release the doctors involved in this COVID-19 test from their medical confidentiality. We process your health data exclusively for the following purposes:
				<ul>
			...
			<h3>Liability</h3>
			<p>
				DocHQ and its partners are only liable for injured life, body, health or for breach of essential contractual obligations (cardinal obligations) as well as for other damages based on an intentional or grossly negligent breach of duty by us, our legal representatives or vicarious agents. Essential contractual applications are those whose fulfillment is necessary to achieve the objective of the contract.
			</p>
			<p>
				In the event of a breach of essential contractual obligations, we are only liable for typical, foreseeable damage if this was caused by simple negligence, unless the client is entitled to claims for damages resulting from injury to life, body or health.
			</p>
			<p>
				DocHQ and their partners are not liable for any damage to my or other’s health or financial property resulting from any issues related to this test.
			</p>
		</Box>
	);
};
